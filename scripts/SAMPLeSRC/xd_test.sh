...
dirr=output/Cross_Dataset/imagenet/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/seed${SEED}/${ENBLR}/rho=${RHO}/alpha=${ALPHA}/lambda=${LAMBDA}/lr=${LR}
SUB=all
...
--output-dir output/evaluation/Cross_Dataset/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/${DATASET}/seed${SEED}/lr=${LR} \
--model-dir ${dirr} \
--load-epoch 20 \
--eval-only \
