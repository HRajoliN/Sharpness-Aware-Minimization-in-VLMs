...
import trainers.SAMPLe
import trainers.SAMPLeSRC
import trainers.SAMPLeMAP
import trainers.SAMPLeCoCoOp
...
#------------------ SAM related ---------------------
#----------------------------------------------------
    cfg.TRAINER.SAMPLe = CN()
    
    cfg.TRAINER.SAMPLe.N_CTX = 16  # number of context vectors
    cfg.TRAINER.SAMPLe.CSC = False  # class-specific context
    # cfg.TRAINER.SAMPLe.CTX_INIT = ""  # initialization words
    cfg.TRAINER.SAMPLe.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.SAMPLe.PREC = "fp32"  # fp16, fp32, amp
    cfg.TRAINER.SAMPLe.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
    cfg.TRAINER.SAMPLe.NORMALIZATION = False 
    cfg.TRAINER.SAMPLe.ADAPTIVE = False 
    cfg.TRAINER.SAMPLe.ENBLR = "None" # "SAM" and "SAMPLe" as available variety of SAM and None for Non-SAM methods
    cfg.TRAINER.SAMPLe.RHO = 0.2    # SAM and SAMPLe perturbation radii
    cfg.TRAINER.SAMPLe.ALPHA = 0.1    # $\hat\theta$ perturbation weigth
    cfg.TRAINER.SAMPLe.EMA_LAMBDA = 0.8
