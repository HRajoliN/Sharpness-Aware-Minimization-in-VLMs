...
DIR=output/Cross_Dataset/${DATASET}/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/seed${SEED}/${ENBLR}/rho=${RHO}/alpha=${ALPHA}/lambda=${LAMBDA}
echo "Run this job and save the output to ${DIR}"
python3 train.py \
--root ${DATA} \
--seed ${SEED} \
